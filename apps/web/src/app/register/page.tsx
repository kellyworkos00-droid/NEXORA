        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-md text-white">
            ...
            <p className="text-xl text-purple-100 mb-8">
              Join thousands of teams using AI-powered CRM to transform their operations.
            </p>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-purple-100">Free account, no credit card required</p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 h-6 w-6 rounded-full bg-white/20 flex items-center justify-center">
                  ✓
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-purple-100">Start managing deals immediately</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
